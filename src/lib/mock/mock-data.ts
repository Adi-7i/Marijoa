...
export const MOCK_MEMBERS: OrganizationMember[] = [
  {
    ...
    role: "OWNER",
    status: "ACTIVE",
    joinedAt: BASE_TS - 90 * 24 * 60 * 60 * 1000,
  },
  {
    id: "member-2",
    organizationId: "org-cynerza",
    ...
    role: "ADMIN",
    status: "ACTIVE",
    joinedAt: BASE_TS - 80 * 24 * 60 * 60 * 1000,
  },
  {
    id: "member-3",
    organizationId: "org-cynerza",
    ...
    role: "MANAGER",
    status: "ACTIVE",
    joinedAt: BASE_TS - 70 * 24 * 60 * 60 * 1000,
  },
  {
    id: "member-4",
    organizationId: "org-cynerza",
    ...
    role: "MEMBER",
    status: "ACTIVE",
    joinedAt: BASE_TS - 60 * 24 * 60 * 60 * 1000,
  },
  {
    id: "member-5",
    organizationId: "org-cynerza",
    ...
    role: "VIEWER",
    status: "ACTIVE",
    joinedAt: BASE_TS - 45 * 24 * 60 * 60 * 1000,
  },
  {
    id: "member-6",
    organizationId: "org-cynerza",
    ...
    email: "ino@cynerza.com",
    initials: "IY",
    role: "MEMBER",
    status: "SUSPENDED",
    joinedAt: BASE_TS - 30 * 24 * 60 * 60 * 1000,
  },
  {
    id: "member-7",
    organizationId: "org-cynerza",
    userId: "user-7",
    fullName: "Rock Lee",
    email: "rock.lee@cynerza.com",
    initials: "RL",
    role: "VIEWER",
    status: "INVITED",
    joinedAt: BASE_TS - 5 * 24 * 60 * 60 * 1000,
  },
];
...
export const MOCK_ADMIN_USAGE: AdminUsageSummary = {
  organizationId: "org-cynerza",
  usersCount: 7,
  activeUsersCount: 5,
  workspacesCount: 5,
  ...
  artifactsCount: 8,
  filesCount: 10,
  storageBytes: Math.round(1.24 * 1024 * 1024 * 1024),
};
...
export const MOCK_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    organizationId: "org-cynerza",
    userId: "user-1",
    userName: "Kakasi Hatake",
    action: "ADMIN_USAGE_VIEWED",
    entityType: "organization",
    entityId: "org-cynerza",
    ipAddress: "192.168.1.10",
    createdAt: BASE_TS - 30 * 60 * 1000,
  },
  {
    id: "audit-2",
    organizationId: "org-cynerza",
    ...
    metadata: { title: "BDE Follow-up Email", type: "email" },
    createdAt: BASE_TS - 3 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-3",
    ...
    entityId: "file-7",
    ipAddress: "10.0.0.5",
    metadata: { filename: "ui-reference.png", sizeBytes: "876544" },
    createdAt: BASE_TS - 1 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-4",
    organizationId: "org-cynerza",
    ...
    entityId: "msg-4",
    ipAddress: "192.168.1.10",
    metadata: { chatId: "chat-3", model: "gpt-4o" },
    createdAt: BASE_TS - 3 * 60 * 60 * 1000,
  },
  {
    id: "audit-5",
    ...
    entityId: "user-1",
    ipAddress: "192.168.1.10",
    createdAt: BASE_TS - 4 * 60 * 60 * 1000,
  },
  {
    id: "audit-6",
    organizationId: "org-cynerza",
    workspaceId: "ws-cynerza-client-tc",
    workspaceName: "Client - Tech Corner",
    userId: "user-1",
    userName: "Kakasi Hatake",
    action: "ARTIFACT_CREATED",
    entityType: "artifact",
    entityId: "artifact-4",
    ipAddress: "192.168.1.10",
    metadata: { title: "Tech Corner Project Proposal", type: "proposal" },
    createdAt: BASE_TS - 5 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-7",
    ...
    entityId: "chat-3",
    ipAddress: "192.168.1.10",
    createdAt: BASE_TS - 6 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-8",
    organizationId: "org-cynerza",
  ...
  },
  {
    ...
    entityId: "member-7",
    ipAddress: "192.168.1.10",
    metadata: { invitedEmail: "rock.lee@cynerza.com", role: "VIEWER" },
    createdAt: BASE_TS - 5 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-10",
    ...
    entityId: "artifact-7",
    ipAddress: "10.0.0.5",
    metadata: { title: "Backend Architecture Notes", version: "3" },
    createdAt: BASE_TS - 1 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-11",
  ...
  },
  {
    ...
    entityId: "file-1",
    ipAddress: "192.168.1.12",
    metadata: { filename: "company-overview.pdf", sizeBytes: "250880" },
    createdAt: BASE_TS - 5 * 24 * 60 * 60 * 1000,
  },
  {
    id: "audit-13",
    ...
    userId: "user-1",
    userName: "Kakasi Hatake",
    action: "AI_STREAM_COMPLETED",
    entityType: "message",
    ipAddress: "192.168.1.10",
    metadata: { model: "gpt-4o", tokensUsed: "812" },
    createdAt: BASE_TS - 3 * 60 * 60 * 1000 + 5000,
  },
  {
    id: "audit-14",
    organizationId: "org-cynerza",
    ...
    entityId: "user-2",
    ipAddress: "192.168.1.12",
    createdAt: BASE_TS - 8 * 60 * 60 * 1000,
  },
  {
    id: "audit-15",
    organizationId: "org-cynerza",
    ...
    entityId: "org-cynerza",
    ipAddress: "192.168.1.10",
    createdAt: BASE_TS - 2 * 24 * 60 * 60 * 1000 + 60000,
  },
];
